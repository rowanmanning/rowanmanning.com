...
resources:
  - src: "frog.jpg"
    title: "Me dressed as a large inflatable frog, strutting down the street"
---
  ...
  * Learning Rust is a nice distraction from everything, a chance to step out of a world of AI hype and just write some stuff for the fun of it ([have we been here before?](/weeknotes/93/)).
  ...
  * So that's been the first half of _this_ week which I'm not even here to write about. Let's talk about gut health and Germany.
  ...
  * It was a fun but tiring week. Carnival in Bonn and Cologne is pretty wild but in a fun happy way rather than the intense way I was expecting. We dressed as Bunte Eier on Thursday. On Saturday, I dressed in an inflatable frog costume, an homage to the [Portland Frogs](https://www.bbc.co.uk/news/articles/cn987yqnee9o).
